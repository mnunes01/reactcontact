...
export default class contactDetails extends React.Component {
  ...
  render () {
    let {firstName, lastName, email, country} = this.state
    return (
      <div className='contactDetails'>
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <label>
            <SelectSearch options={COUNTRY_LIST} value={country} name='country' onChange={this.handleCountryChange} placeholder='Choose your Country' />
          </label>
